...
void setting_init(Client *c)
{
    ...
    i = 14;
    setting_add(c, "enable-accelerated-2d-canvas", TYPE_BOOLEAN, &off, webkit, 0, "enable-accelerated-2d-canvas");
    ...
    setting_add(c, "enable-caret-browsing", TYPE_BOOLEAN, &off, webkit, 0, "enable-caret-browsing");
    setting_add(c, "cursive-font-family", TYPE_CHAR, &"serif", webkit, 0, "cursive-font-family");
    ...
    setting_add(c, "default-font-family", TYPE_CHAR, &"sans-serif", webkit, 0, "default-font-family");
    setting_add(c, "enable-dns-prefetching", TYPE_BOOLEAN, &on, webkit, 0, "enable-dns-prefetching");
    i = SETTING_DEFAULT_FONT_SIZE;
    setting_add(c, "default-font-size", TYPE_INTEGER, &i, webkit, 0, "default-font-size");
    setting_add(c, "enable-frame-flattening", TYPE_BOOLEAN, &off, webkit, 0, "enable-frame-flattening");
    ...
    setting_add(c, "enable-html5-database", TYPE_BOOLEAN, &on, webkit, 0, "enable-html5-database");
    setting_add(c, "enable-html5-local-storage", TYPE_BOOLEAN, &on, webkit, 0, "enable-html5-local-storage");
    setting_add(c, "enable-hyperlink-auditing", TYPE_BOOLEAN, &off, webkit, 0, "enable-hyperlink-auditing");
    setting_add(c, "auto-load-images", TYPE_BOOLEAN, &on, webkit, 0, "auto-load-images");
    ...
    setting_add(c, "enable-javascript-markup", TYPE_BOOLEAN, &on, webkit, 0, "enable-javascript-markup");
#endif
    ...
    setting_add(c, "enable-media-stream", TYPE_BOOLEAN, &off, webkit, 0, "enable-media-stream");
    setting_add(c, "enable-mediasource", TYPE_BOOLEAN, &off, webkit, 0, "enable-mediasource");
    i = 5;
    setting_add(c, "minimum-font-size", TYPE_INTEGER, &i, webkit, 0, "minimum-font-size");
    setting_add(c, "monospace-font-family", TYPE_CHAR, &"monospace", webkit, 0, "monospace-font-family");
    i = SETTING_DEFAULT_MONOSPACE_FONT_SIZE;
    setting_add(c, "default-monospace-font-size", TYPE_INTEGER, &i, webkit, 0, "default-monospace-font-size");
    setting_add(c, "notification", TYPE_CHAR, &"ask", notification, FLAG_NODUP, NULL);
    setting_add(c, "enable-offline-web-application-cache", TYPE_BOOLEAN, &on, webkit, 0, "enable-offline-web-application-cache");
    setting_add(c, "enable-plugins", TYPE_BOOLEAN, &on, webkit, 0, "enable-plugins");
    ...
    setting_add(c, "sans-serif-font-family", TYPE_CHAR, &"sans-serif", webkit, 0, "sans-serif-font-family");
    setting_add(c, "enable-jacascript", TYPE_BOOLEAN, &on, webkit, 0, "enable-javascript");
    setting_add(c, "serif-font-family", TYPE_CHAR, &"serif", webkit, 0, "serif-font-family");
    setting_add(c, "enable-site-specific-quirks", TYPE_BOOLEAN, &off, webkit, 0, "enable-site-specific-quirks");
    setting_add(c, "enable-smooth-scrolling", TYPE_BOOLEAN, &off, webkit, 0, "enable-smooth-scrolling");
    setting_add(c, "enable-spatial-navigation", TYPE_BOOLEAN, &off, webkit, 0, "enable-spatial-navigation");
    setting_add(c, "enable-tabs-to-links", TYPE_BOOLEAN, &on, webkit, 0, "enable-tabs-to-links");
    setting_add(c, "enable-webaudio", TYPE_BOOLEAN, &off, webkit, 0, "enable-webaudio");
    setting_add(c, "enable-webgl", TYPE_BOOLEAN, &off, webkit, 0, "enable-webgl");
    setting_add(c, "enable-developer-extras", TYPE_BOOLEAN, &on, webkit, 0, "enable-developer-extras");
    setting_add(c, "enable-xss-auditor", TYPE_BOOLEAN, &on, webkit, 0, "enable-xss-auditor");
